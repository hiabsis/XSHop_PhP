...
class ErrorEnum
{
    ...
    public static $ERROR_20002=["code"=>20002, "message"=>"登陆已过期,请重新登陆"];
    public static $ERROR_20003=["code"=>20003, "message"=>"非法操作"];
    public static $ERROR_40001=["code"=>40001, "message"=>"用户积分不足"];
    public static $ERROR_40002=["code"=>40002, "message"=>"商品不存在"];
    public static  $ERROR_40003=["code"=>40003,"message"=> "库存不足"];
   public static  $ERROR_90003=["code"=>90003, "message"=>"缺少必填参数"];
   public static  $ERROR_30001=["code"=>30001,"message"=> "文件不存在"];
   public static  $ERROR_30002=["code"=>30002,"message"=> "文件不存在"];
